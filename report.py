...
"""
    ...
    res += f"""
На занятии {student.name} {behavior_text} старается, видно, что хочет понять предмет. Мы приложим все усилия и сведём допускаемые ошибки к минимуму. Отработаем и усилим необходимые навыки для успешного освоения школьной программы и получения высоких отметок.
"""
